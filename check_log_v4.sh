...
CHECK_LOG_V='============Log Compliance Analysis Tool v4==========='


regex_rule="[0-9][0-9]-[0-9][0-9]\s+[0-9][0-9]:[0-9][0-9]:[0-9][0-9].[0-9]{1,4}\s+[0-9]{1,5}\s+[0-9]{1,5}\s+[VDIWFE]\s[^:]*:"
...
function analyze_one_file_log()
{
			...
			grep -n -v -P "$regex_rule" $1 >> $ERR_LOG_FILE
