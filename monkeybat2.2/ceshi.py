...
redbutton = Button(frame, text="名单测试", fg="red",command = monkey_cmd_md)
redbutton.pack( side = LEFT)

redbutton = Button(frame, text="整机测试", fg="red",command = monkey_cmd_zj)
redbutton.pack( side = LEFT)

greenbutton = Button(frame, text="中断MONKEY", fg="brown",command = kill_monkey)
greenbutton.pack( side = LEFT )

bluebutton = Button(frame, text="KMSG-LOG", fg="blue",command = kmsg_cmd)
bluebutton.pack( side = LEFT )

blackbutton = Button(bottomframe, text="中断LOGCAT", fg="black",command = kill_logcat)
blackbutton.pack( )

bluebutton = Button(frame, text="结束测试", fg="blue",command = end_test)
bluebutton.pack( side = LEFT )

blackbutton = Button(bottomframe, text="启动LOG_parser", fg="black",command = python_other_cmd)
blackbutton.pack()
